...
<div class="card-body">
<form action="{{ route('manager.objectives.update', $objective) }}" method="POST">
    @csrf
    @method('PATCH') <!-- Use PATCH to match your route -->
    ...
    <div class="row">
        <div class="col-xs-6 col-sm-6 col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="objective" value="{{ old('objective', $objective->objective) }}" class="form-control" required>
            </div>
        </div>
    </div>
